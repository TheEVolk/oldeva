local command = botcmd.new("валакас", "заменяет лицо на валакаса", {use="(картинка)"})
...
function command.exe(msg, args, other, rmsg, user)
    ...
    ca(rmsg.attachment ~= "noface", "на картинке, которую вы мне дали нет человеческого лица. Кого валакасить?")
end
