local command = botcmd.new("жмыхфейс", "жмыхает лицо на картинке", {use="(картинка)"})
...
function command.exe(msg, args, other, rmsg, user)
    ...
    ca(rmsg.attachment ~= "noface", "на картинке, которую вы мне дали нет человеческого лица. Кого жмыхать?")

    user:unlockAchiv('jmihface')
end
